...
var ReactFiberBeginWork = function (config, hostContext, hydrationContext, scheduleWork, computeUpdatePriorityForFiber, recalculateCurrentTime, computeExpirationTimeForPriority) {
  ...
  function updateContextConsumer(current, workInProgress, renderExpirationTime) {
    ...
    if (typeof render !== 'function') {
      invariant_1(false, 'A context consumer was rendered with multiple children, or a child that isn\'t a function. A context consumer expects a single child that is a function. If you did pass a function, make sure there is no trailing or leading whitespace around it.');
    }
      ...
      case HostRoot:
        {
          ...
          !(_updateQueue3 !== null && _updateQueue3.capturedValues !== null) ? invariant_1(false, 'An error logging effect should not have been scheduled if no errors were captured. This error is likely caused by a bug in React. Please file an issue.') : void 0;
